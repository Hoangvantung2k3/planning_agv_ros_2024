...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_description_SOURCE_PREFIX /home/tung/planning_agv_ros_2024/src/velodyne_simulator/velodyne_description)
  set(velodyne_description_DEVEL_PREFIX /home/tung/planning_agv_ros_2024/devel)
  ...
  set(velodyne_description_INSTALL_PREFIX /home/tung/planning_agv_ros_2024/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tung/planning_agv_ros_2024/src/velodyne_simulator/velodyne_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tung/planning_agv_ros_2024/devel/lib;/home/tung/catkin_ws/devel/lib;/opt/ros/noetic/lib)
